...
2. Clone the repo
   ```sh
   git clone https://github.com/LuizPaschoalin/Portifolio_Social_Media/issues.git
   ```
...
See the [open issues](https://github.com/LuizPaschoalin/Portifolio_Social_Media/issues/issues) for a full list of proposed features (and known issues).
